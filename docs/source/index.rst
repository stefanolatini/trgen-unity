...
.. image:: https://img.shields.io/badge/Unity-2021.3%2B-000000?style=flat&logo=unity&logoColor=white
   :target: https://img.shields.io/badge/Unity-2021.3%2B-000000?style=flat&logo=unity&logoColor=white
   :alt: Unity


.. image:: https://img.shields.io/badge/.NET-Standard%202.1-512BD4?style=flat&logo=dotnet&logoColor=white
   :target: https://img.shields.io/badge/.NET-Standard%202.1-512BD4?style=flat&logo=dotnet&logoColor=white
   :alt: .NET


.. image:: https://img.shields.io/badge/C%23-9.0-239120?style=flat&logo=c-sharp&logoColor=white
   :target: https://img.shields.io/badge/C%23-9.0-239120?style=flat&logo=c-sharp&logoColor=white
   :alt: C#


.. image:: https://img.shields.io/badge/Platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey?style=flat
   :target: https://img.shields.io/badge/Platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey?style=flat
   :alt: Platform


.. image:: https://img.shields.io/badge/License-MIT-green?style=flat
   :target: https://img.shields.io/badge/License-MIT-green?style=flat
   :alt: License


.. image:: https://img.shields.io/badge/Version-1.0.2-blue?style=flat
   :target: https://img.shields.io/badge/Version-1.0.2-blue?style=flat
   :alt: Version


.. image:: https://img.shields.io/npm/v/com.cosanlab.trgen?label=openupm&registry_uri=https://package.openupm.com
   :target: https://openupm.com/packages/com.cosanlab.trgen/
   :alt: openupm
...
As explained in this `Mermaid <https://github.com/mermaid-js/mermaid>`_ diagram, we see that we can "attach" n (0-25) TrgenPorts to the ``TrgenClient``
...
#. Enter: ``https://github.com/stefanolatini/trgen-unity.git``
#. Click **\ ``Add``\ **
...
#. Download the latest release from `GitHub Releases <https://github.com/stefanolatini/trgen-unity/releases>`_
...
**Cognitive and Social Action Lab (CoSANLab)**\ :raw-html-m2r:`<br>`
Sapienza University of Rome\ :raw-html-m2r:`<br>`
`Website <https://research.uniroma1.it/laboratorio/144782>`_ | `GitHub <https://github.com/CoSANLabRome>`_

📞 Support
----------


* **🐛 Issues**\ : `GitHub Issues <https://github.com/stefanolatini/trgen-unity.git/issues>`_
* **💬 Discussions**\ : `GitHub Discussions <https://github.com/stefanolatini/trgen-unity.git/discussions>`_
* **📧 Email**\ : 
